...
function Player() {
  ...
  const {enrolledCourses, calculateChapterTime, backendURL,userData,getToken,fetchUserEnrolledCourses} = useContext(AppContext)
                  ...
                  <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                    {chapter.chapterContent.map((lecture, i) => (
                      <li key={i} className="flex items-start gap-2 py-1">
                        ...
                        <div className="flex items-center justify-between w-full text-green-800 text-xs md:text-default">
        ...
        <div className='md:mt-10'>
          {
            ...
            : <img src={courseData?.courseThumbnail || null} alt="Course Thumbnail" />
          }
        </div>
      </div>
