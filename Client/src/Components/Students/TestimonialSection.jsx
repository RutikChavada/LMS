  ...
  return (
    <div className='pb-14 px-8 md:px-0'>
        ...
        <p className='md:text-base text-gray-500 mt-3'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis in rerum omnis, eaque autem itaque, rem atque officia <br /> praesentium iste dolorum tempora qui, inventore consequuntur pariatur labore dolorem deserunt porro.
        </p>
        <div className='grid grid-cols-3 px-40 gap-8 mt-14'>
